<template>
    ...
    <div class="email-wrapper height-calc-150 border bg-white">
        <div class="email-sidebar p-4">
            <div class="mb-3">
                <button type="button" class="btn btn-light-theme w-100">
                    <i class="bi bi-plus-lg"></i>
                    <span class="ms-2"> Compose </span>
                </button>
            </div>
            <div class="mb-3">
                <button type="button" class="btn px-0 border-0 d-flex justify-content-between align-items-center text-light-gray-hover w-100 mb-2">
                    <span>
            ...
            <div class="container-fluid">
                <div class="height-70 row align-items-center px-2">
                    ...
                    <div class="col-5 col-lg-8 d-flex justify-content-end align-items-center">
                        <button type="button" class="btn-icon rounded-circle p-0">
